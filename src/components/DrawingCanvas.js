    ...
    const styles = reactCSS({
        ...
        return (
            ...
            <div className="d-flex m-3 justify-content-around">
                <button className="button-red col-md-4 mx-3" onClick={() => { endCanvas(); }}><h3 className="p-1 m-0 text-red">CANCEL GAME</h3></button>
            
                <button className="button-blue col-md-4 mx-3" onClick={() => {
